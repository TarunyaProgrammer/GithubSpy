...
export const TacticalBriefing: React.FC<TacticalBriefingProps> = ({ intelligence, fullName }) => {
  ...
  return (
    <div className="w-full my-4 p-5 sm:p-6 rounded-3xl bg-gradient-to-b from-white via-white to-zinc-50 dark:from-obsidian-900 dark:via-obsidian-900 dark:to-obsidian-950 border border-zinc-200/90 dark:border-zinc-800 shadow-xl shadow-zinc-200/40 dark:shadow-2xl relative overflow-hidden">
      ...
      {/* Header Badge */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pb-4 border-b border-zinc-100 dark:border-zinc-800/80">
        <div className="flex items-center gap-2.5">
          <div className="p-2 rounded-xl bg-champagne-500/15 text-champagne-500">
            <Compass className="w-4 h-4 animate-spin" style={{ animationDuration: '18s' }} />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <span className="text-[11px] font-mono uppercase tracking-widest font-semibold text-champagne-600 dark:text-champagne-400">
            ...
            <h3 className="text-base sm:text-lg font-display font-bold text-zinc-900 dark:text-white">
        ...
        {/* Grade Callout */}
        <div className="flex items-center gap-2">
          <span className="text-xs text-zinc-500 font-mono">Assessment:</span>
          <span
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 my-4">
        {/* Feasibility Gauge */}
        <div className="p-4 rounded-2xl bg-zinc-50/70 dark:bg-obsidian-850/60 border border-zinc-200/60 dark:border-zinc-800/70 space-y-2">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-zinc-500 font-mono">index points</span>
          </div>
        ...
        {/* Competition Density */}
        <div className="p-4 rounded-2xl bg-zinc-50/70 dark:bg-obsidian-850/60 border border-zinc-200/60 dark:border-zinc-800/70 space-y-1.5">
          <div className="flex items-center justify-between text-xs">
            <span className="text-zinc-500 dark:text-zinc-400 font-medium flex items-center gap-1.5">
          ...
          <p className="text-[11px] text-zinc-500">Other community applicants active in this timeframe.</p>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-zinc-50/70 dark:bg-obsidian-850/60 border border-zinc-200/60 dark:border-zinc-800/70 space-y-1.5">
          ...
          <div className="pt-0.5">
            ...
            <p className="text-[11px] text-zinc-500 mt-1">Based on timestamp differential from PR creation to merge.</p>
          </div>
        </div>
      </div>

      {/* Actionable Strategic Takeaway */}
      <div className="mt-4 p-4 rounded-2xl bg-brand-50/40 dark:bg-brand-950/20 border border-brand-200/70 dark:border-brand-900/40 text-xs font-sans text-zinc-700 dark:text-zinc-300">
