...
export function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-50 dark:bg-[#090a0f] text-zinc-900 dark:text-zinc-100 transition-colors duration-200">
      {/* Top Navigation */}
      <Header
        darkMode={darkMode}
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        {/* Error Banner */}
        {error && (
          <div className="my-6 p-4 rounded-2xl bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-900 text-red-800 dark:text-red-300 flex items-start justify-between gap-3 text-sm animate-fade-in" role="alert">
        ...
        {loadingUser && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs" aria-live="assertive">
        ...
        {stats && (
          <div className="space-y-4 animate-fade-in">
            {/* Tactical Intelligence Dossier (Proprietary Advantage) */}
            <TacticalBriefing
        ...
        {/* Empty State */}
        {!stats && !loading && !error && (
          <div className="mt-16 py-14 text-center rounded-3xl border border-dashed border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-obsidian-900/40">
            <div className="w-12 h-12 mx-auto mb-3 rounded-2xl bg-zinc-100 dark:bg-zinc-800/80 flex items-center justify-center text-zinc-400">
